...
public class RegistrationAdapter extends BaseAdapter {
    ...
    public RegistrationAdapter(Context context, int days, int week, int day, int[] sginNumber) {
        this.context = context;
        this.days = days;
        this.week = week;
        this.day=day;
        this.sginNumber=sginNumber;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        //初始化签到
        if (dayNumber[i]!=0&&dayNumber[i]<=day&&sginNumber[i]==1){
            viewHolder.day.setBackgroundResource(R.mipmap.member_ok);
        }
        if (dayNumber[i]==day&&sginNumber[i]==0){
