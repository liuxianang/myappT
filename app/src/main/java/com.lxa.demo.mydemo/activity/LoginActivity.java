...
import com.lxa.demo.mydemo.util.Base64Utils;
...
import com.lxa.demo.mydemo.widget.LoadingDialog;
...
public class LoginActivity extends Activity
    ...
    private String path = CoreConst.serverhost+"/api-app/app/login";
    @Override
...
//       return password;   //解码一下
    ...
    private boolean firstLogin() {
        ...
        if (first) {
            ...
            helper.putValues(new SharedPreferencesUtils.ContentValue("first", false),
                    ...
                    new SharedPreferencesUtils.ContentValue("loginname", ""),
        ...
        Thread loginRunnable = new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    HttpUtlis.getRequest(path, map, "utf-8", new OnResponseListner() {
                        @Override
               ...
               JSONObject jsonObject;
                try {
                    jsonObject = new JSONObject(code);
                      ...
                      code = jsonObject.getString("msg");//图片网址
    ...
    public void loadUserName() {
        if (!getAccount().equals("") || !getAccount().equals("请输入登录账号")) {
            SharedPreferencesUtils helper = new SharedPreferencesUtils(this, "setting");
            helper.putValues(new SharedPreferencesUtils.ContentValue("loginname", getAccount()));
        }
